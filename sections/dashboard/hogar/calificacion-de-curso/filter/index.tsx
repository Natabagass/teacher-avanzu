...
const FilterCalificacion = ({ setFilteredData, filteredData, dataResponse }: { setFilteredData: any, filteredData: any, dataResponse: any }) => {
...
export default FilterCalificacion;
