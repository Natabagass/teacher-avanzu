...
import ConfiguracionPercidad from "../step/step2";
                ...
                <div className="flex flex-row w-[70%] gap-5">
                    {
                        profileStep.map((item, index) => (
                            <div key={item.id} onClick={() => setActive(item.id)} className="flex flex-col w-full text-center gap-3 cursor-pointer">
